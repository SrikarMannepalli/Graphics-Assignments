...
let Train = class {
    constructor(gl, dim, pos,type) {
        ...
        this.pos = [];
        var temp = pos;
        this.positions.push(getCube(this.width, this.height, 0.01));
        this.pos.push([temp[0], temp[1], temp[2]-0.5*this.depth]);
        this.positions.push(getCube(this.width, this.height, 0.01));
        this.pos.push([temp[0], temp[1], temp[2]+0.5*this.depth]);
        this.positions.push(getCube(0.01, this.height, this.depth));
        this.pos.push([temp[0]-0.5*this.width, temp[1], temp[2]]);
        this.positions.push(getCube(0.01, this.height, this.depth));
        this.pos.push([temp[0]+0.5*this.width, temp[1], temp[2]]);
        this.positions.push(getCube(this.width, 0.01, this.depth));
     ...
     // gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(colors), gl.STATIC_DRAW);
      ...
      this.texture = [];
      this.texture.push(loadTexture(gl, 'train-front.jpeg'));
      this.texture.push(loadTexture(gl, 'train-front.jpeg'));
      this.texture.push(loadTexture(gl, 'train-side.jpeg'));
      this.texture.push(loadTexture(gl, 'train-side.jpeg'));
      this.texture.push(loadTexture(gl, 'train-top.jpeg'));
      this.texture.push(loadTexture(gl, 'train-top.jpeg'));
